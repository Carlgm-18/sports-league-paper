...
% navegació a través de les diferents referències (figures, bibliografia, 
% fórmules, índex, ...) tant sols assenyalant-los amb el ratolí. 
\usepackage[breaklinks=true, backref, colorlinks=true, all colors=black]{hyperref}

% Configuración para mejorar el espaciado y evitar advertencias de overfull/underfull
% Aumenta la tolerancia para la justificación de párrafos.
\tolerance=1000
...
\title{Sports League: Diseño e Implementación de un Sistema para la Gestión de Ligas Deportivas}
...
\tutor{Antonio Crespí Tobeña, Maria Monserrat Barceló}

% Indicau el curs acadèmic que correspongui.
\date{Año académico 2025-26}

% Indicau les paraules claus del vostre treball.
\paraulesclau{Liga deportiva, Aplicación multiplataforma, Spring Boot, React Native, TFG}
...
\begin{agraiments}
Gracias a todos los profesores que me han ayudado a lo largo de mi carrera, en especial, a Raimon Massanet. Su asignatura me ha permitido entender el desarrollo de sistemas con arquitecturas limpias y patrones de diseño. Gracias también a mis tutores Antonio Crespí Tobeña y Maria Monserrat Barceló por toda su implicación al revisar las distintas versiones de la memoria para cumplir con los estándares académicos. También me gustaría agradecer a mis dos mejores amigos y compañeros del grado Jesús Castillo y Mark Link por haberme acompañado durante estos cuatro años y haberlos convertido en los mejores de mi vida. Por último, me gustaría agradecer a mi pareja, Alba, por estar este último año y medio dándome apoyo para poder acabar el grado.
\end{agraiments}
