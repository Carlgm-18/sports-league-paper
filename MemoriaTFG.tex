...
% Para personalizar listas y enumeraciones
% como las de los requisitos funcionales.
\usepackage{enumitem}

% Para poder usar tablas que ocupan varias páginas,
% como la de los requisitos.
...
\begin{agraiments}
Gracias a todos los profesores que me han ayudado a lo largo de mi carrera, y en especial a mi primer tutor Raimon Massanet Vila por haber confiado en mi idea y, mi segundo tutor, Antonio Crespí Tobeña por su apoyo y orientación durante la realización de este trabajo, aun habiendo tenido que coger el relevo cuando el primer 
tutor tuvo que ser relevado por motivos burocráticos.
\end{agraiments}
