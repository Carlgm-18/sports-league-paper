...
En la Cuadro~\ref{tab:comparativa-backend} se resumen las características fundamentales de cada entorno.
...
En la Cuadro~\ref{tab:comparativa-bd} se resumen las principales características técnicas evaluadas.
...
En la Cuadro~\ref{tab:comparativa-os} se analizan las soluciones basándonos en las necesidades del entorno de desarrollo y producción del proyecto.
...
En la Cuadro~\ref{tab:comparativa-frontend} se detalla la comparativa técnica de las tecnologías evaluadas.
