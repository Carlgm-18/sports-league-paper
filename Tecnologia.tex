...
Para gestionar la evolución del esquema y asegurar la reproducibilidad del entorno, se ha integrado \textbf{Flyway}, herramienta que permite aplicar un control de versiones estricto sobre las migraciones \emph{.sql}.

\section{Almacenamiento de objetos (Object Storage)}
