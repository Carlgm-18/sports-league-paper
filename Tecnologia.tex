...
Por otra parte, para la gestión de dependencias/librerías externas se utilizará el gestor de paquetes \emph{npm}: gestor por defecto para manejar las dependencias en proyectos de JavaScript.
