...
Los objetivos principales que han buscado cumplir a trevés del desarrollo de Sports League es:
...
\begin{enumerate}
    ...
    \item \textbf{Unificar el sistema para todos los roles:} el sistema debe ser capaz de ofreceer las funcionalidades necesarias para completar la gestión de las ligas para cualquier tipo de usuario partícipe en estas: jugador, capitán, árbitro y administrador.
\end{enumerate}
